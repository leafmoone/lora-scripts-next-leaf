...
Modules:
  anima_ip_attention    — IP Cross-Attention layer (concat-mode fusion)
  anima_ip_converter    — DiT Block wrapper injector
  anima_ip_image_proj   — Image projection (ImageProjModel / MultiStreamProj)
  anima_ip_adapter      — Inference wrapper
  ccip_encoder          — CCIP character identity encoder (CAFormer-b36)
