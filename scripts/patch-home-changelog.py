...
CHANGELOG_HTML_INNER = """<p align="center"><a href="https://github.com/wochenlong/lora-scripts-next" style="margin:2px;"><img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/wochenlong/lora-scripts-next"></a><a href="https://github.com/wochenlong/lora-scripts-next" style="margin:2px;"><img alt="GitHub forks" src="https://img.shields.io/github/forks/wochenlong/lora-scripts-next"></a><a href="https://raw.githubusercontent.com/wochenlong/lora-scripts-next/master/LICENSE" style="margin:2px;"><img src="https://img.shields.io/github/license/wochenlong/lora-scripts-next" alt="license"></a><a href="https://github.com/wochenlong/lora-scripts-next/releases" style="margin:2px;"><img src="https://img.shields.io/github/v/release/wochenlong/lora-scripts-next?color=blueviolet&amp;include_prereleases" alt="release"></a></p><h3 id="版本记录" tabindex="-1"><a class="header-anchor" href="#版本记录" aria-hidden="true">#</a> 版本记录</h3><h4 id="v2-3-0" tabindex="-1"><a class="header-anchor" href="#v2-3-0" aria-hidden="true">#</a> v2.3.0</h4><ul><li>整合包：跳过 triton-windows，修复嵌入式 Python 启动崩溃</li><li>run_gui.bat：启动日志 sd-trainer-log.txt，失败不再无声闪退</li><li>训练监控：跨盘 output_dir 不再断联</li><li>品牌/logo 临时更新，CONTRIBUTORS.md</li></ul><h4 id="v2-1-0" tabindex="-1"><a class="header-anchor" href="#v2-1-0" aria-hidden="true">#</a> v2.1.0</h4><ul><li>Flash Attention 2 预构建 Wheel 支持 Windows（无需 C++ 编译器）</li><li>新增按步数保存模型选项</li><li>修复 LoKr conv_dim/conv_alpha 显示为 undefined 的问题</li><li>修复跨盘符 output_dir 导致监控页面断联的问题</li><li>新增 triton-windows 依赖自动安装</li></ul><h4 id="v2-0-0" tabindex="-1"><a class="header-anchor" href="#v2-0-0" aria-hidden="true">#</a> v2.0.0</h4><ul><li>Windows 便携包发布，双击即用</li><li>Flash Attention 2 自动加速（自动检测并启用）</li><li>AMD GPU 检测与友好提示</li><li>自动 bf16/fp16 修复</li><li>--browser chrome/edge 浏览器选择</li><li>更新检查功能</li></ul><h4 id="v1-next" tabindex="-1"><a class="header-anchor" href="#v1-next" aria-hidden="true">#</a> 基于原版的改进</h4><ul><li>Anima 训练支持（LoRA / LoKr / T-LoRA）</li><li>T-LoRA 支持（Timestep-Dependent LoRA）</li><li>交互式 Loss 曲线图（ECharts 缩放/平移）</li><li>实时训练监控页面（端口 6008）</li><li>Anima 后端迁移至 kohya-ss/sd-scripts</li><li>AutoDL 专用启动脚本</li></ul><h3 id="原版更新日志" tabindex="-1"><a class="header-anchor" href="#原版更新日志" aria-hidden="true">#</a> 原版更新日志</h3><p>本项目 Fork 自 <a href="https://github.com/Akegarasu/lora-scripts" target="_blank" rel="noopener noreferrer">Akegarasu/lora-scripts</a>，原版更新日志请参见原仓库。</p>"""

HOME_BODY_HTML = """<div class="sd-home-onboarding"><h2 id="项目简介" tabindex="-1"><a class="header-anchor" href="#项目简介" aria-hidden="true">#</a> 项目简介</h2><p><strong>SD-Trainer</strong> 是基于秋叶版 <a href="https://github.com/Akegarasu/lora-scripts" target="_blank" rel="noopener noreferrer">lora-scripts</a> 的 Stable Diffusion 训练 WebUI（本 fork：<a href="https://github.com/wochenlong/lora-scripts-next" target="_blank" rel="noopener noreferrer">lora-scripts-next</a>）。在浏览器里配置模型路径、数据集与训练参数，一键启动训练；支持 LoRA、Dreambooth、Anima、Flux 等。</p><h2 id="新手上路" tabindex="-1"><a class="header-anchor" href="#新手上路" aria-hidden="true">#</a> 新手上路</h2><ol><li><strong>准备数据</strong>：图片 + 同名标签文件；可用左侧「工具与调试 → 数据集打标」。</li><li><strong>选训练类型</strong>（左侧「训练」）：<ul><li><a href="/lora/sd3.html"><strong>Anima</strong></a> — Anima DiT（推荐主入口）</li><li><a href="/lora/flux.html"><strong>Flux</strong></a> — Flux LoRA</li><li><a href="/lora/master.html"><strong>Stable Diffusion</strong></a> — SD1.5 / SDXL（页内切换，默认 SDXL）</li><li><a href="/dreambooth/index.html"><strong>Dreambooth 训练</strong></a> — 全量微调</li></ul></li><li><strong>填参数并开训</strong>：中栏表单 + 右栏「开始训练」；进度可开 <a href="/tensorboard.html">Tensorboard</a> 或 <a href="/train-monitor">训练监控</a>。</li></ol><h2 id="从秋叶版迁移" tabindex="-1"><a class="header-anchor" href="#从秋叶版迁移" aria-hidden="true">#</a> 从秋叶版迁移</h2><p>若你习惯原 <strong>Akegarasu/lora-scripts</strong>（秋叶一键包），本版主要变化如下：</p><ul><li><strong>导航</strong>：按「训练 / 工具 / 帮助 / 其他」分组；LoRA 下聚合 Anima、Flux、SD；原「新手 / 专家」不再平铺于侧栏（SD1.5 精简页仍可访问 <a href="/lora/basic.html">/lora/basic.html</a>）。</li><li><strong>Anima</strong>：原 SD3 位置改为 Anima 训练（Qwen + T5 + DiT）。</li><li><strong>监控</strong>：独立训练监控页、Loss 曲线、实时日志（<code>/train-log</code>）。</li><li><strong>其他</strong>：便携包优化、Flash Attention 自动加速、AMD 提示等（详见 <a href="/other/changelog.html">更新日志</a>）。</li></ul><p class="sd-home-tip">参数含义见「帮助 → 训练参数说明」；反馈与联系方式见「其他 → 关于」。</p></div>"""
